package com.github.joao_felisberto.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.github.joao_felisberto.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside(
            "com.github.joao_felisberto.gateway.security.DomainUserDetailsService",
