 ...
 */
@RestController
@RequestMapping("/api/DEPRECATED/addresses")
@Transactional
public class AddressResource {

    private static final Logger LOG = LoggerFactory.getLogger(AddressResource.class);

    private static final String ENTITY_NAME = "microserviceAddress";
        ...
        Optional<Address> result = addressRepository
            ...
            .map(existingAddress -> {
                ...
                if (address.getStreetTwo() != null) {
                    existingAddress.setStreetTwo(address.getStreetTwo());
                }
                if (address.getEmailAddress() != null) {
                    existingAddress.setEmailAddress(address.getEmailAddress());
                }
