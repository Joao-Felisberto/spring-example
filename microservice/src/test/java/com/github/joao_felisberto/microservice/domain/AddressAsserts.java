...
public class AddressAsserts {
    ...
    public static void assertAddressUpdatableFieldsEquals(Address expected, Address actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getStateOrProvince()).as("check stateOrProvince").isEqualTo(expected.getStateOrProvince()))
            .satisfies(a -> assertThat(a.getStreetOne()).as("check streetOne").isEqualTo(expected.getStreetOne()))
            .satisfies(a -> assertThat(a.getStreetTwo()).as("check streetTwo").isEqualTo(expected.getStreetTwo()))
