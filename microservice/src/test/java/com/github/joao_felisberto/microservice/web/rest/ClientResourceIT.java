...
class ClientResourceIT {
    ...
    public static Client createEntity() {
        return new Client().name(DEFAULT_NAME).nif(DEFAULT_NIF);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client().name(UPDATED_NAME).nif(UPDATED_NIF);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME).nif(UPDATED_NIF);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nif(UPDATED_NIF);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME).nif(UPDATED_NIF);
