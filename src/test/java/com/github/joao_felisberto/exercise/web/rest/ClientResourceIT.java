...
import static com.github.joao_felisberto.exercise.domain.ClientAsserts.*;
import static com.github.joao_felisberto.exercise.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.github.joao_felisberto.exercise.domain.Client;
import com.github.joao_felisberto.exercise.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    public static Client createEntity() {
        return new Client().name(DEFAULT_NAME).nif(DEFAULT_NIF).address(DEFAULT_ADDRESS).phone(DEFAULT_PHONE);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client().name(UPDATED_NAME).nif(UPDATED_NIF).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME).nif(UPDATED_NIF).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.address(UPDATED_ADDRESS);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME).nif(UPDATED_NIF).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
